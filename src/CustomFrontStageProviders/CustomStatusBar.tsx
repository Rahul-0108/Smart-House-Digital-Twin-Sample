 ...
 * StatusBarWidgetControl extends WidgetControl extends ConfigurableUiControl extends ConfigurableBase extends ConfigurableUielement
 */
export class CustomStatusBarWidget extends StatusBarWidgetControl {
 ...
 constructor(info: ConfigurableCreateInfo, options: any) {
  ...
  this._statusBarItems.push(
   StatusBarItemUtilities.createStatusBarItem("PreToolAssistance", StatusBarSection.Left, 15, this._footerModeOnlySeparator())
  );
  this._statusBarItems.push(
   StatusBarItemUtilities.createStatusBarItem("ToolAssistance", StatusBarSection.Left, 20, <ToolAssistance />)
  );
  this._statusBarItems.push(
   StatusBarItemUtilities.createStatusBarItem("PostToolAssistance", StatusBarSection.Left, 25, this._footerModeOnlySeparator())
  );
